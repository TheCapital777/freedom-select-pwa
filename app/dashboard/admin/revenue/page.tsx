  ...
  return (
    <div style={{ background: "#0C0C0C", minHeight: "100vh", padding: "28px 20px 80px" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "28px" }}>
        <div style={{ width: "3px", height: "26px", background: "#22c55e", borderRadius: "var(--radius-stamp)", flexShrink: 0 }} />
        <div>
      ...
      <motion.div
        ...
        <p style={{ fontSize: "12px", fontWeight: 700, letterSpacing: "0.18em", textTransform: "uppercase", color: "#22c55e", marginBottom: "8px" }}>Net Platform Revenue</p>
      ...
      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}
        ...
        <p style={{ fontSize: "12px", fontWeight: 700, letterSpacing: "0.18em", textTransform: "uppercase", color: "#FFBB1C", marginBottom: "22px" }}>Vendor Revenue Contribution</p>
        {VENDORS.map((v, i) => {
            ...
            <motion.div key={v.id} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.25 + i * 0.08 }}
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", gap: "12px", marginBottom: "10px" }}>
                <div style={{ display: "flex", alignItems: "center", gap: "12px", minWidth: 0 }}>
                  ...
                  <div style={{ minWidth: 0 }}>
                    <p style={{ fontWeight: 800, fontSize: "16px", marginBottom: "4px" }}>{v.name}</p>
              ...
              <div style={{ height: "8px", borderRadius: "var(--radius-plate)", background: "#1E1E1E" }}>
                <motion.div
                  ...
                  style={{ height: "8px", borderRadius: "var(--radius-plate)", background: "#FFBB1C" }} />
              </div>
            </motion.div>
          );
        })}
      ...
      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}
        ...
        <p style={{ fontSize: "12px", fontWeight: 700, letterSpacing: "0.18em", textTransform: "uppercase", color: "#FFBB1C", marginBottom: "20px" }}>Order Revenue Ledger</p>
        {ORDERS.map((o, i) => (
          <div key={o.id} style={{
            ...
            <div style={{ textAlign: "right", flexShrink: 0 }}>
              <p style={{ ...num, fontSize: "16px", fontWeight: 900, color: "#22c55e", marginBottom: "5px" }}>+{formatTZS(o.commission)}</p>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", gap: "14px", paddingTop: "20px", borderTop: "1px solid #242424", marginTop: "4px" }}>
          ...
          <p style={{ ...num, fontWeight: 900, fontSize: "17px", color: "#22c55e", textAlign: "right" }}>{formatTZS(totalRevenue)}</p>
        </div>
      </motion.div>
    </div>
  );
